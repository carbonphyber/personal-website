  ...
  return (
    <div className="container">
      ...
      <section>
        ...
        <div className="row">
          <div className="one-half column">
            <h3><a href="#projects--kryptos" id="projects--kryptos" className="anchor" aria-hidden="true"><span className="octicon octicon-link"></span></a>Kryptos Sculture at CIA Headquarters, Langley, VA</h3>
          ...
          <div className="one-half column">
            <h3><a href="#projects--best-cheap-dog-food" id="projects--best-cheap-dog-food" className="anchor" aria-hidden="true"><span className="octicon octicon-link"></span></a>Best Cheap Dog Food</h3>
